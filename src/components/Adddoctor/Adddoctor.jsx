...
const Adddoctor = (props) => {
    ...
    const [area_uni, setArea_uni] = useState(["Área Universidad", ""])
    const [area_con, setArea_con] = useState(["Área Conocimiento", ""])
    ...
    useEffect(() => {
        ...
        const handleSubmit = async (event,p) => {
            ...
            if(p){
                ...
                uploadData.append('is_doctor',is_doctor);

                try {
                    const createdProfessional = await axios.post("http://127.0.0.1:8000/api/profesional/",uploadData)
                    if(props.onAddProfessional){
                        props.onAddProfessional(createdProfessional.data)
                    }
                    navigate('/')
                } catch (error) {
    ...
    <div className=''>
        <div className='"text-gray-800 text-2xl font-semibold ml-7'>Insertar Doctor</div>
            ...
            <div id='popup-inner' className='flex'>
                <div>
                    ...
                    <div className='flex place-content-end'>
                        ...
                        <div className='mr-10 mt-5'><input
                            value={"Añadir"}  
                            type="submit" 
